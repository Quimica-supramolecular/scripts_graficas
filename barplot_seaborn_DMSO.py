# -*- coding: utf-8 -*-
"""
Created on Wed Nov  3 22:42:25 2021
...
masy = {"label": "masy ($\lambda_{em} = 368 nm$)"}
...
wasy = {"label": "wasy ($\lambda_{em} = 423 nm$)"}
...
fig2.suptitle("Fluorescence of receptors on solid-phase with tetraalkylammonium salts in DMSO", size=15)
...
fig2.savefig('Grafica_cual_sns_DMSO_FS.png', dpi=1000, bbox_inches="tight")